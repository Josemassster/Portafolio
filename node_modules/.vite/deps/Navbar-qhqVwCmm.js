...
import { a as useBootstrapPrefix, s as require_classnames } from "./ThemeProvider-LJrvm-0-.js";
import { c as usePrevious, d as useUncontrolled, i as SelectableContext, l as useMounted, m as _objectWithoutPropertiesLoose$3, n as dataAttr, o as qsa, s as useIsomorphicEffect_default, t as context, u as useEventCallback } from "./NavbarContext-Cy2PFg3q.js";
import { d as ownerDocument, i as useEventCallback$1, n as useWindow, o as useMergedRefs, r as contains, s as listen, t as useIsomorphicEffect_default$1, u as canUseDOM_default } from "./useIsomorphicEffect-DeMY8PXn.js";
...
var Transition = /*#__PURE__*/ function(_React$Component) {
	...
	_proto.render = function render() {
		...
		_this$props.nodeRef;
		var childProps = _objectWithoutPropertiesLoose$3(_this$props, [
			"children",
			"in",
			"mountOnEnter",
			"unmountOnExit",
...
function NoopTransition({ children, in: inProp, onExited, mountOnEnter, unmountOnExit }) {
	...
	const combinedRef = useMergedRefs$1(ref, getChildRef(children));
...
function useRTGTransitionProps(_ref) {
	...
	const nodeRef = (0, import_react.useRef)(null);
	const mergedRef = useMergedRefs$1(nodeRef, getChildRef(children));
	const normalize = (callback) => (param) => {
		if (callback && nodeRef.current) callback(nodeRef.current, param);
	};
	const handleEnter = (0, import_react.useCallback)(normalize(onEnter), [onEnter]);
...
//#endregion
export { isEscKey as A, TransitionWrapper as C, transitionEndListener as D, createChainedFunction as E, EXITING as M, require_prop_types as N, transitionEnd as O, Collapse as S, triggerBrowserReflow as T, renderTransition as _, OffcanvasTitle as a, CloseButton as b, OffcanvasBody as c, NavbarBrand as d, AbstractModalHeader as f, Modal_default as g, hasClass as h, Offcanvas_default as i, ENTERING as j, getChildRef as k, NavbarToggle as l, getSharedManager as m, NavbarText as n, OffcanvasHeader as o, ModalContext as p, NavbarOffcanvas as r, OffcanvasToggling as s, Navbar_default as t, NavbarCollapse as u, NoopTransition as v, safeFindDOMNode as w, Fade as x, useWaitForDOMRef as y };
